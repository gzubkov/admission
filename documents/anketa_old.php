...
// пол
if ($appl->sex == 'M') {
    $pdf->cross(37.32, 47.1, 4);
//} else {
    $pdf->cross(61.8, 47.15, 4);
}

$pdf->SetFont("times", "", 12);

$pdf->Text(42.4, 56.8, date('d      m       y', strtotime($r['birthday'])));
...
// паспорт
$pdf->SetFont("times", "", 13);
$pdf->Text(117.4, 50.9, $r['doc_serie']);
$pdf->Text(153, 50.9, $r['doc_number']);

$pdf->SetFont("times", "", 12);
$pdf->splitText($r['doc_issued'], array(array(126.2,57),array(105.6,62.8)), 32, 1);

$pdf->Text(141.4, 68.78, $r['doc_code']); // код подразделения
