...
<html>
    ...
    <body>
        ...
        <p>Для поступления в Московский государственный технический университет (МАМИ) на заочную форму обучения с использованием дистанционных образовательных технологий, Вам необходимо выслать по электронной почте <A href=\"mailto: iit@ins-iit.ru\">iit@ins-iit.ru</A> комплект документов:
<UL type=\"disc\">
